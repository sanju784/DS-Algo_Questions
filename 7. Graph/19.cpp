/**
 * Count total Strongly Connected Components in a Graph
 */
...
void Graph::printSCCs()
{
    ...
    while(!stk.empty())
    {
        ...
        //Counting Strongly Connected Components from the popped Vertex
        if(visited[v] == false)
        {
...
int main()
{
    ...
    cout<<"Total Strongly Connected Components of Graph are \n";
    g.printSCCs();
